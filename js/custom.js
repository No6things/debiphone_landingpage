...
/*----------------------------------------------------*/
    ...
    $("#sendgrid-buttom")
      .click(function (e) {
        ...
        var dataString ='api_user=debiphone'+'&api_key=deb1t4ndo'+ '&to=support@debiphone.com' + '&toname=Debiphone' + '&subject=' + subject + '&from='+email + '&text=' + text ;

        var dataString2 ='api_user=debiphone'+'&api_key=deb1t4ndo'+'&list=Debiphone' + '&data=' + JSON.stringify(subscriberData);
...
$("#unsubscribe-buttom")
  .click(function (e) {
    ...
    var dataString ='api_user=debiphone'+'&api_key=deb1t4ndo'+'&list=Debiphone' + '&email=' + email;

    var dataString2 ='api_user=debiphone'+'&api_key=deb1t4ndo'+ '&to=support@debiphone.com' + '&toname=Debiphone' + '&subject=' + subject + '&from=support@debiphone.com' + '&text=' + text ;
